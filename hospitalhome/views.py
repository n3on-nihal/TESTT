# def index(request):
#     return render(request,'hospital-home/index.html')
...
#     return render(request, 'hospital-home/paitent-register.html', context)

# def doctor_register(request):
#     return render(request, 'hospital-home/doctor-register.html')
...
#     return render(request, 'hospital-home/paitent-login.html')
...
from hospitalhome.models import Hospital_Information, User, Patient 
...
def hospital_home(request):
    ...
    return render(request, 'hospital-home/index.html', context)
...
#     if request.user.is_patient:
#         # patient = Patient.objects.get(user_id=pk)
#         print(2,request.user.patient_id)
#         try:
