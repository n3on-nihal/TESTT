...
urlpatterns = [
    ...
    # path('doctor-login/', views.not_working, name='doctor-login'),
    # # path('doctor-login/', views.not_working, name='reset-password'),
    # path('doctor-login/', views.not_working, name='admin-login'),
